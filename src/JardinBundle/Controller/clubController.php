...
class clubController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $clubs = $em->getRepository('JardinBundle:club')->findAll();

        return $this->render('@Jardin/club/index.html.twig', array(
            'clubs' => $clubs,
        ));
    }
    ...
    {
        $club = new Club();
        $form = $this->createForm('JardinBundle\Form\clubType', $club);
        ...
        return $this->render('@Jardin/club/new.html.twig', array(
            'club' => $club,
    ...
    public function showAction(club $club)
    {
        ...
        return $this->render('@Jardin/club/show.html.twig', array(
            'club' => $club,
    ...
    {
        $deleteForm = $this->createDeleteForm($club);
        $editForm = $this->createForm('JardinBundle\Form\clubType', $club);
        ...
        return $this->render('@Jardin/club/edit.html.twig', array(
            'club' => $club,
